import { TestingServiceHttpService } from './testing-service-http.service';
...
describe('Service: TestingServiceHttp', () => {
  let service: TestingServiceHttpService;
  let httpTestingController: HttpTestingController;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule],
      providers: [TestingServiceHttpService],
    });

    // Returns a service with the MockBackend so we can test with dummy responses
    service = TestBed.get(TestingServiceHttpService);
  ...
  it('should return search SearchItems', fakeAsync(() => {
    const response = {
        resultCount: 1,
        results: [
            {
